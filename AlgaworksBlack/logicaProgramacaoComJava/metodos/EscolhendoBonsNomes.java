...
public class EscolhendoBonsNomes {
    public static void main(String[] args) {
        ...
        Integer posicaoCursoEscolhido = receberNumeroInteiroDoUsuario("O curso que voce deseja e o: ", scanner);
        ...
        Integer posicaoFormaPagamentoEscolhida = receberNumeroInteiroDoUsuario("Sua forma de pagamento escolhida e" ,scanner);
        ...
        imprimir("O curso escolhido foi " + cursoEscolhido + " e a forma de pagamento e " + formaPagamentoEscolhida);
