package JavaNotesForProfessionals.cap_22_BitManipulation;

public class UsingLongBitMask {
    ...
    private static void checkBitMask(long bitmask) {
        System.out.println("FIRST_BIT: " + ((bitmask & FIFTH_BIT) != 0));
        System.out.println("FIRST_BIT: " + ((bitmask & SECOND_BIT) != 0));
        System.out.println("FIRST_BIT: " + ((bitmask & THIRD_BIT) != 0));
        System.out.println("FIRST_BIT: " + ((bitmask & FOURTH_BIT) != 0));
        System.out.println("FIRST_BIT: " + ((bitmask & FIFTH_BIT) != 0));
        System.out.println("FIRST_BIT: " + ((bitmask & BIT_55) != 0));
    }
}
