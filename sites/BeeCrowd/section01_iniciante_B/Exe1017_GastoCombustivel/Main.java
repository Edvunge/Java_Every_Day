package sites.BeeCrowd.section01_iniciante_B.Exe1017_GastoCombustivel;
...
*/
    public static void main(String[] args) {
        ...
        GastoDeCombustivel gastoDeCombustivel = new GastoDeCombustivel();

        System.out.println("Tempo gasto na viagem(em horas):  ");
        gastoDeCombustivel.tempGastoH = input.nextDouble();

        System.out.println("velocidade media (em KM/H):  ");
        gastoDeCombustivel.velocidadeMediaKM = input.nextDouble();

        gastoDeCombustivel.quantidadeLitros = gastoDeCombustivel.tempGastoH * gastoDeCombustivel.velocidadeMediaKM;
        System.out.printf("Quantidade de litros:  %.2f ", gastoDeCombustivel.quantidadeLitros);
